...
// readQuote("tuesday")
// This function is used to create some fake data
function writeHikes() {
    ...
    .get()   //the collection called "hikes"
        .then(allHikes => {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                // Assigning an uniquie id to the book mark icon 
                // Attaching an onclick, calling the callback function (with the doc id of the hike)
